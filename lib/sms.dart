...
class sms extends StatefulWidget {
  ...
  final IconData reloadIcon = Icons.perm_identity;
  final IconData fireIcon = Icons.perm_identity;
  ...
  ListTile _buildListTile(CustomContact c, List<Item> list) {
    return ListTile(
      leading: CircleAvatar(
        child: Text(
            (c.contact.displayName[0] + c.contact.displayName[1].toUpperCase()),
